export const features = [
  {
    ...
    caption: "",
    title: "What is Eagle Agents",
    text: "Eagle Agents is an AI-powered geoscience platform that transforms how we discover and analyze mineral resources. By integrating decades of historical data with real-time feeds, it empowers geologists to pinpoint opportunities faster and with greater accuracy.",
  ...
  },
  {
    ...
    caption: "",
    title: "                                                ",
    text: "Purpose-built for mineral exploration, Eagle Agents merges advanced machine learning with geological know-how, slashing data-analysis timelines from weeks to minutes. The result is quicker, data-driven decisions that fuel innovation in mining and beyond.",
...
export const details = [
  ...
  },
  {
    ...
    title: "Geoscience-Driven Insights",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Expert-Tuned Knowledge Base",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "Multimodal Data Handling",
    answer:
      "PDFs, Excel, GIS layers, images, etc ",
  },
  {
    id: "1",
    question: "24×7 Operation",
    answer:
      "Continuous ingestion & analysis of new data.",
  },
  {
    id: "2",
    question: "Multichannel Data Utilisation",
    answer:
      "Uses historic unstructured data, real-time geo-satellites feed, web access, APIs -  generate research reports on critical metals",
  },
  {
    id: "3",
    question: "Rapid Turnaround",
    answer:
      " Transform weeks of effort into minutes.",
  },
  {
    id: "4",
    question: "Domain-Focused AI",
    answer:
      " Enriched with geoscience heuristics for accurate results.",
  },
  {
    id: "5",
    question: "Knowledge Bases",
    answer:
      "A modular KB structure allows domain experts to fine-tune each metal’s exploration rules, ensuring geologically sound recommendations rather than generic text matches.",
  },
];
